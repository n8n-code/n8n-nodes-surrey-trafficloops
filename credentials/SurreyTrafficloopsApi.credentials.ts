...
export class SurreyTrafficloopsApi implements ICredentialType {
	name = 'N8nDevSurreyTrafficloopsApi';

	displayName = 'surrey-trafficloops API';

	icon: Icon = { light: 'file:../nodes/SurreyTrafficloops/surrey-trafficloops.png', dark: 'file:../nodes/SurreyTrafficloops/surrey-trafficloops.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your surrey-trafficloops API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
